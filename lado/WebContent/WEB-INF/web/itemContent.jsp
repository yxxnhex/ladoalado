            ...
            <div class="row">
                ...
                <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-2047px, 0px, 0px); transition: all 1.2s ease 0s; width: 4095px;"><div class="owl-item cloned" style="width: 292.5px;"><div class="col-lg-3">
                        ...
                        <div class="product__item">
                            ...
                            <div class="product__item__text">
                                <h6><a href="#">연관상품1</a></h6>
                                <div class="product__item__price">연관상품1 가격</div>
                                <div class="cart_add">
                                    <a href="#">Add to cart</a>
                                </div>
                            </div>
                        ...
                        <div class="product__item">
                            ...
                            <div class="product__item__text">
                                <h6><a href="#">연관상품2</a></h6>
                                <div class="product__item__price">연관상품2 가격</div>
                                <div class="cart_add">
                                    <a href="#">Add to cart</a>
                                </div>
                            </div>
                        ...
                        <div class="product__item">
                            ...
                            <div class="product__item__text">
                                <h6><a href="#">연관상품3</a></h6>
                                <div class="product__item__price">연관상품3 가격</div>
                                <div class="cart_add">
                                    <a href="#">Add to cart</a>
                                </div>
                            </div>
